...
using ILNumerics;
using ILNumerics.Community.WebExport;
...
public partial class WebPlotDemoForm : Form
{
    ...
    private void btnExportPlotly_Click(object sender, EventArgs e)
    {
        ...
        var chart = WebExport.GetChart(currentScene);

        if (chart != null)
            webView.CoreWebView2.NavigateToString(chart.Render());
        else
        {
